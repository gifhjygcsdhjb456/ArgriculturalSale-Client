  ...
  <div class="goods-box2">
    <div style="width: 100%">
      <el-carousel :interval="5000" arrow="always" height="400px">
        <el-carousel-item>
          <img src="../assets/lib1.jpg" style="width: 100%; height: 100%" />
        </el-carousel-item>
        <el-carousel-item>
          <img src="../assets/lib2.jpg" style="width: 100%; height: 100%" />
        </el-carousel-item>
        <el-carousel-item>
          <img src="../assets/lib3.jpg" style="width: 100%; height: 100%" />
        </el-carousel-item>
      </el-carousel>
    </div>
    ...
    <div class="goods" v-for="(item, index) in cgoods" :key="index" @click="detailsClick(item.orderId)">
