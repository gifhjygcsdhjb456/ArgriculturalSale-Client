    ...
    <div class="login">
      <div id="login_form">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="" name="password" placeholder="Password" v-model="password" />
        </div>
        ...
        <button class="btn btn-success btn-block" @click="loginBtn">登录</button>
        <div class="message">
