<template>
  <div>
    <el-row>
      <el-button class="back" @click="goBack" type="primary" size="medium" icon="el-icon-caret-left" plain
        >返回</el-button
      >
    </el-row>
            ...
            <el-popover placement="right" width="320" trigger="hover">
              <div>
                <div class="item-sales">
                  买家昵称：<span class="sales-text">{{ updateUserData.nickName }}</span>
                </div>
                <div class="item-sales">
                  买家地址：<span class="sales-text">{{ updateUserData.address }}</span>
                </div>
                <div class="item-sales">
                  买家手机号码：<span class="sales-text">{{ updateUserData.phone }}</span>
                </div>
                <div class="item-sales">
                  更新时间：<span class="sales-text">{{ updateUserData.updateTime | formatTimer }}</span>
                </div>
              </div>
              <el-button
                type="danger"
        ...
        <div class="comment-item" v-for="(item, index) in commentArray" :key="index">
          ...
          <div class="comment-tips">
            <div style="margin-right: 40px">
              评论人：<span class="color6">{{ item.userName }}</span>
            </div>
            <div>
...
div {
  ...
  .comment-container {
    ...
    .comment-item {
      border-bottom: 1px solid #deddddda;
      padding: 10px 8px;
      margin: 10px 0;
